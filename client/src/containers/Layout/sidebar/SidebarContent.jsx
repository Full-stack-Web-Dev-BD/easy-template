  ...
  return (
    <div className="sidebar__content">
      ...
      <ul className="sidebar__block">
        ...
        <SidebarCategory title="KPI Dashboard" icon="diamond" sidebarCollapse={sidebarCollapse}>
          <SidebarLink title="Portfolio Management" route="/kpi/portfolio-management" onClick={hideSidebar} />
          <SidebarLink title="Business Development" route="/kpi/business-development" onClick={hideSidebar} />
          <SidebarLink title="Performance" route="/kpi/kpi-performance" onClick={hideSidebar} />
        </SidebarCategory>
